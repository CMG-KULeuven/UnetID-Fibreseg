...
def get_dataloaders(data, image_size, val_percent, batch_size, data_aug=None):
    """
    Generate train and validation dataloaders from the given data.
    
    Args:
        data (tuple): images and masks
        image_size (tuple): Size of images in the dataset.
    ...
    dataset = fs.CTImagesDataset(data, transform=data_transform)

...
class Annotator(PyQt5.QtWidgets.QWidget):
    ...
    def __init__(self, size=None, annotation_file=None):
        '''
        ...
        if annotation_file == None:
            self.saveAddress = 'annotation.png'
        else:
            self.saveAddress = annotation_file
    ...
    @classmethod  
    def fromGrayscale(cls, gray, annotation_file):
        '''
        ...
        imagePix = PyQt5.QtGui.QPixmap(qimage)
        annotator = Annotator(imagePix.size(), annotation_file)
        annotator.imagePix = imagePix
...
def annotate(image, annotation_file=None):
    app = PyQt5.QtWidgets.QApplication([])
    ex = Annotator.fromGrayscale(image, annotation_file)
    ex.show()
    app.exec()       
